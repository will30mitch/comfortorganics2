  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-200 to-yellow-100 flex flex-col items-center py-12 px-4">
      ...
      <div className="w-full max-w-4xl bg-gradient-to-r from-green-500 to-yellow-400 rounded-2xl shadow-lg mb-12 p-8 flex flex-col items-center">
        ...
        <p className="text-xl text-white text-center font-light">Review your selected products and proceed to secure checkout</p>
      </div>
      <div className="bg-white rounded-2xl shadow p-8 border-t-4 border-green-500 max-w-xl w-full text-center">
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div className="font-bold text-xl mb-4" style={{ color: 'black' }}>Subtotal: ${total.toFixed(2)}</div>
            <div className="text-sm text-gray-600 mb-4">
              Shipping and handling will be calculated at checkout
            </div>
            <button
              className="bg-green-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-green-700 transition mb-2 disabled:opacity-50 w-full"
